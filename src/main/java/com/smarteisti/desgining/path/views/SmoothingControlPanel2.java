...
public class SmoothingControlPanel2 extends RPanel implements ActionListener, PropertiesListener {
    ...
    public SmoothingControlPanel2(Properties props, int width, int height, String label) {
        ...
        pnl.setLayout(new GridLayout(1, 2, 10, 3));

        cbShowActualPath = new JCheckBox("Afficher chemin");
        pnl.add(cbShowActualPath);
        cbShowActualPath.setBackground(Color.ORANGE);
