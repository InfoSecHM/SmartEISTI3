...
public class DrawingPanel2 extends JPanel implements MouseMotionListener, MouseListener, AlgorithmListener {
    ...
    public DrawingPanel2(DiscreteWorld w, int width, int height) {
