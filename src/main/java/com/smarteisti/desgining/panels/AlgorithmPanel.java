...
import com.smarteisti.desgining.algorithms.Heuristic;
...
import com.smarteisti.internal.PropertiesListener;
import com.smarteisti.internal.RPanel;
import com.smarteisti.desgining.algorithms.AStarAlgorithm;
import com.smarteisti.desgining.algorithms.Algorithm;
import com.smarteisti.desgining.algorithms.BFSAlgorithm;
import com.smarteisti.desgining.algorithms.DFSAlgorithm;
import com.smarteisti.utils.UIUtils;
...
public class AlgorithmPanel extends RPanel implements ActionListener, PropertiesListener, WorldListener {
	...
	private void createControlPanelContents(JPanel pnlNorth) {
		...
		rbDFS = new JRadioButton("Parcours en profondeur");
		...
		rbBFS = new JRadioButton("Parcours en largeur");
		...
		rbAStar = new JRadioButton("Parcours A*");
